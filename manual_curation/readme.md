This readme file describes the specific steps and parameters used for the manual curation of repeats mentioned at the section Methods in the publication entitled ***article's name***. The metodology is based on the guidelines described elsewhere (Goubert, C., Craig, R.J., Bilat, A.F. et al. A beginner’s guide to manual curation of transposable elements. Mobile DNA 13, 7 (2022). https://doi.org/10.1186/s13100-021-00259-7). The bibliography associated to each software can be found in that article. The scripts that we used for manual curation are included and were obtained by sligthly modifying the ones provided at the Goubert's et al. article.
